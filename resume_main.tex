% !TeX program = xelatex
% ABOVE MAGIC COMMENT --> https://www.joelotz.com/blog/2022/enabling-different-latex-compilers-in-vs-code.html
\documentclass{my_cv}
\title{Resume}
...
\begin{multicols}{3}
    \section{\badge{flashyGreen}{\texttt{\Large {\textbf{Front-end Developer}}}}}
    \columnbreak
    \section{\xhrulefill{black}{0.6em}}
    \columnbreak
    \section{\xhrulefill{black}{0.6em} }
\end{multicols}
